...
HD_PWD='D:/FPGA/vivadoproject/PL_part/PL_part.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pl_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pl_top.tcl
