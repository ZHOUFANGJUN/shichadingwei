...
HD_PWD='D:/FPGA/vivadoproject/PL_part2/PL_part/PL_part.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pl_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pl_top.tcl -notrace
