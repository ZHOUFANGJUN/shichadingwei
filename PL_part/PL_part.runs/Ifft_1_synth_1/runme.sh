...
HD_PWD='D:/FPGA/vivadoproject/PL_part/PL_part.runs/Ifft_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Ifft_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Ifft_1.tcl
